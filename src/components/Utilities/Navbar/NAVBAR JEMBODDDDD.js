...
const Navbar = () => {
    ...
    return (
        <>
            <nav className="bg-white/10 z-50 select-none rounded-[15] flex justify-between py-4 px-10 sm:px-5 items-center backdrop-blur-xs fixed text-2 font-medium shadow-xl my-8 inset-x-0 mx-auto w-[90%] sm:w-150">
